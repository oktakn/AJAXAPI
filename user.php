...
<html lang="en">
  ...
  <body>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="user.php">POST</a></li>
    ...
    <li class="wikipedia-container">
      <center>
        <h3 id="wikipedia-header">Ini Link unyuk Redirect Ke Wikipedia </h3>
        <ul id="wikipedia-links">Dibawah Ini Link Sesuai Yang Diinputkan</ul>
        </center>
    </li>
      </body>
